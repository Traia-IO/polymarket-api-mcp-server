...
Generated from OpenAPI: https://docs.polymarket.com/developers/gamma-markets-api/

Environment Variables:
- POLYMARKET_API_KEY: Server's internal API key (for paid requests)
...
if not API_KEY:
    logger.warning(f"⚠️  POLYMARKET_API_KEY not set - payment required for all requests")
...
@require_payment_for_tool(
    price=TokenAmount(
        amount="70000000000000008",  # 0.07 tokens
        asset=TokenAsset(
            address="0x3e17730bb2ca51a8D5deD7E44c003A2e95a4d822",
            decimals=6,
            network="sepolia",
